...
<?php $this->renderBegin(); ?>
    ...
    <div id="instructions">
        <h1 class="instruction_title">Bootstrap: Form Examples</h1>
    ...
    <ul class="nav nav-pills">
        <li role="presentation"><a href="<?= Application::instance()->context()->scriptName() . '?formName=forms1' ?>">Default</a></li>
        <li role="presentation"><a href="<?= Application::instance()->context()->scriptName() . '?formName=forms2' ?>">Inline</a></li>
        <li role="presentation"><a href="<?= Application::instance()->context()->scriptName() . '?formName=forms3' ?>">Horizontal</a></li>
        <li role="presentation"><a href="<?= Application::instance()->context()->scriptName() . '?formName=forms4' ?>">Horizontal 2</a></li>
        <li role="presentation" class="active"><a href="<?= Application::instance()->context()->scriptName() . '?formName=forms5' ?>">Horizontal 3</a></li>
    </ul>
