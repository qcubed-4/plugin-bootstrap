...
{
    /** @var  string */
    protected ?string $strActiveItemId = null;
    /** @var  string */
    protected string $strButtonStyle;
    /** @var  bool */
    protected bool $blnJustified;
    ...
    /**
     * Retrieves a styled list item based on the provided item and applies specific styles
     * if the item is the active one.
     *
     * @param mixed $objItem The item to be styled. Typically an object with identifiable properties.
     *
     * @return ListItemStyle|null The styled item or null if no styling is applied.
     */
     ...
     * @param array $params
     */
    protected function tab_Click(ActionParams $params): void
    {
     ...
     * @return string
     */
    protected function renderChildPanelName(ControlBase $objControl): string
    {
        if ($this->strActiveItemId === null) {
     ...
     * @throws Caller
     */
    protected function renderPanels(): string
    {
        $strHtml = '';
        foreach ($this->getChildControls() as $objControl) {
